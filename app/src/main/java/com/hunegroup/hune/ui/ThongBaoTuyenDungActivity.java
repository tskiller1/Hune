...
public class ThongBaoTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {

    private ImageView imgBack;
    private ImageView imgCheckedAll;
    private LinearLayout lnFooter;
    private RelativeLayout rlTuyendung;
    private RelativeLayout rlHethong;
    private ListView listThongBao;
    private TextView txt_SoTuyenDung, txt_SoHeThong;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thongbao_tuyendung);
        findViews();
    ...
    private void findViews() {
        ...
        listThongBao.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (item.getType() == 4) {
                    Intent intent = new Intent(ThongBaoTuyenDungActivity.this, ChiTietKhuyenMaiTuyenDungActivity.class);
                    intent.putExtra("ads_id", item.getExtra().getAds_id());
                    startActivity(intent);
                } else if (item.getPost_id() != 0 && item.getType() != 3) {
                    if (item.getType() == Integer.parseInt(Common.Type.TYPE_SEARCH_JOB)) {
                        Intent intent = new Intent(getBaseContext(), ChiTietUngVienTuyenDungActivity.class);
                        intent.putExtra(Common.JsonKey.KEY_USER_ID, item.getOwner_post());
                        intent.putExtra("id_post", item.getPost_id());
    ...
    private void setListThongBao(String index) {
        ...
        getNotificationServer getNotificationServer = new getNotificationServer();
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.imgCheckedAll: {
                final Dialog dialog = new Dialog(ThongBaoTuyenDungActivity.this);
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        if (!jsondata.isNull(Common.JsonKey.KEY_NOTIFICATION_ENROLLMENT) && jsondata.getInt(Common.JsonKey.KEY_NOTIFICATION_ENROLLMENT) != 0) {
                            String slTuyenDung = String.valueOf(jsondata.getInt(Common.JsonKey.KEY_NOTIFICATION_ENROLLMENT));
                            txt_SoTuyenDung.setText(slTuyenDung);
                        } else
                            txt_SoTuyenDung.setText("0");
