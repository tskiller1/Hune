...
import com.hunegroup.hune.adapter.DanhSachYeuThichAdapter;
...
public class DanhSachYeuThichTuyenDungActivity extends AppCompatActivity {
    ...
    private DanhSachYeuThichAdapter danhSachYeuThichAdapter;
    private boolean loading = false;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        switchLangauge(this,true);
        setContentView(R.layout.activity_danhsachyeuthich_tuyendung);
        sessionUser = new SessionUser(getBaseContext());
        list = new ArrayList<>();
        findViews();

        favouriteDTOList = new ArrayList<>();
        danhSachYeuThichAdapter = new DanhSachYeuThichAdapter(DanhSachYeuThichTuyenDungActivity.this,favouriteDTOList);
    ...
    private void findViews() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DanhSachYeuThichTuyenDungActivity.this,DangTuyenTuyenDungActivity.class));
            }
        });
        ...
        imgNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DanhSachYeuThichTuyenDungActivity.this,ThongBaoTuyenDungActivity.class));
            }
        });
