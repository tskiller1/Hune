...
public class CaiDatTuyenDungActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
            ...
            public void onSuccess(Sharer.Result result) {
                Toast.makeText(CaiDatTuyenDungActivity.this,getString(R.string.camonbandachiase), Toast.LENGTH_SHORT).show();
            }
        ...
        setContentView(R.layout.activity_caidat_tuyendung);
        findViews();
    ...
    private void findViews() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CaiDatTuyenDungActivity.this,DangTuyenTuyenDungActivity.class));
            }
        });
        ...
        imgNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CaiDatTuyenDungActivity.this,ThongBaoTuyenDungActivity.class));
            }
        });
        ...
        txtNgonNgu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CaiDatTuyenDungActivity.this,ChonNgonNguActivity.class));
            }
        });
        txtDangXuat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CaiDatTuyenDungActivity.this,WelcomeActivity.class) ;
        ...
        txtThongTin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CaiDatTuyenDungActivity.this,ThongTinActivity.class);
                intent.putExtra(ThongTinActivity.REQUEST_CODE, Common.Type.TYPE_ENROLLMENT);
                startActivity(intent);
            }
        });
        ...
        txtDanhGiaUngDung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent launchIntent = CaiDatTuyenDungActivity.this.getPackageManager().getLaunchIntentForPackage("com.android.vending");
