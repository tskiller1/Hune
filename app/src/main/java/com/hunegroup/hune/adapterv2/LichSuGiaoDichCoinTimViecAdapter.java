...
public class LichSuGiaoDichCoinTimViecAdapter extends ArrayAdapter<TransactionDTO> {
    ...
    // Constructors
    public LichSuGiaoDichCoinTimViecAdapter(Context context, List<TransactionDTO> objects) {
        super(context, 0, objects);
        this.mInflater = LayoutInflater.from(context);
    }

    public LichSuGiaoDichCoinTimViecAdapter(Context context, TransactionDTO[] objects) {
        super(context, 0, objects);
        this.mInflater = LayoutInflater.from(context);
    }
}
