...
public class LichSuGiaoDichCashTuyenDungAdapter extends ArrayAdapter<TransactionDTO> {
    ...
    // Constructors
    public LichSuGiaoDichCashTuyenDungAdapter(Context context, List<TransactionDTO> objects) {
        super(context, 0, objects);
        this.mInflater = LayoutInflater.from(context);
    }

    public LichSuGiaoDichCashTuyenDungAdapter(Context context, TransactionDTO[] objects) {
        super(context, 0, objects);
        this.mInflater = LayoutInflater.from(context);
    }
}
