...
public class CouponCuaToiTuyenDungAdapter extends RecyclerView.Adapter<CouponCuaToiTuyenDungAdapter.CouponHolder> {
    private Context mContext;
    private List<MyCoupon> mList;

    int selectItem = -1;

    public CouponCuaToiTuyenDungAdapter(Context mContext, List<MyCoupon> mList) {
    ...
    public void onBindViewHolder(final CouponHolder holder, int position) {
        ...
        if (selectItem == position) {
            holder.lnlCopy.setBackgroundResource(R.drawable.custom_button_danhgia_tuyendung);
            ...
            holder.lnlCopy.setBackgroundResource(R.drawable.custom_edittext_danhgia_tuyendung);
            holder.tvCopy.setTextColor(mContext.getResources().getColor(R.color.color_main));
            holder.imvCopy.setImageResource(R.mipmap.ic_copy_main);
        }
