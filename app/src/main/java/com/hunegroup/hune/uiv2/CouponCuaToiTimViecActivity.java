...
import com.hunegroup.hune.adapterv2.CouponCuaToiTimViecAdapter;
...
public class CouponCuaToiTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    List<MyCoupon> mList;
    CouponCuaToiTimViecAdapter mAdapter;
    Gson gson = new Gson();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_couponcuatoi_timviec);
        findViews();
        initData();
    }
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mAdapter = new CouponCuaToiTimViecAdapter(this, mList);
