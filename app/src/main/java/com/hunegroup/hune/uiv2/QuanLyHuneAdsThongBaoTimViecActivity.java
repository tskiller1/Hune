...
public class QuanLyHuneAdsThongBaoTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quanlyhuneads_thongbao_timviec);
        findViews();
        initData();
    }
    ...
    private void updateView() {
        ...
        for (int i = 0; i < item.getAds_branch().size(); i++) {
            View view = LayoutInflater.from(this).inflate(R.layout.item_v2_branch_thongbao_timviec, null);
            ...
            tvQRCode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(QuanLyHuneAdsThongBaoTimViecActivity.this, MaQRTimViecActivity.class);
