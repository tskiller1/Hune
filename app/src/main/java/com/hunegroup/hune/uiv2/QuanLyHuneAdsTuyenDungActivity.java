...
public class QuanLyHuneAdsTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quanlyhuneads_tuyendung);
        findViews();
        initData();
    }
    ...
    private void findViews() {
        ...
        lsvBody.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (item.getType() == 1) {
                    Intent intent = new Intent(QuanLyHuneAdsTuyenDungActivity.this, QuanLyHuneAdsThongBaoTuyenDungActivity.class);
                    intent.putExtra("id_ads", item.getId());
                    startActivity(intent);
                } else if (item.getType() == 2) {
                    Intent intent = new Intent(QuanLyHuneAdsTuyenDungActivity.this, QuanLyHuneAdsKhuVucTuyenDungActivity.class);
                    intent.putExtra("id_ads", item.getId());
                    startActivity(intent);
                } else if (item.getType() == 3) {
                    Intent intent = new Intent(QuanLyHuneAdsTuyenDungActivity.this, QuanLyHuneAdsBannerTuyenDungActivity.class);
                    intent.putExtra("id_ads", item.getId());
                    startActivity(intent);
                }
            }
    ...
    private void initData() {
        ...
        adsServer.execute(sessionUser.getUserDetails().getToken(), "1");
    }
