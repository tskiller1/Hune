...
import com.hunegroup.hune.adapterv2.DanhSachLamViecTimViecAdapter;
...
public class DanhSachViecLamTimViecActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    DanhSachLamViecTimViecAdapter mAdapter;
    Gson gson = new Gson();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_danhsachvieclam_timviec);
        findViews();
        initData();
    }
    ...
    private void findViews() {
        ...
        lsvBody.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(DanhSachViecLamTimViecActivity.this, ThongTinViecLamTimViecActivity.class);
...
//                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mAdapter = new DanhSachLamViecTimViecAdapter(this, mList);
