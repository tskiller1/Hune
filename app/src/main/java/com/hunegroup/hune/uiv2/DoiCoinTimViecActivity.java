...
public class DoiCoinTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_doicoin_timviec);
        findViews();
        initData();
    }
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        DialogUtils.dialogSuccessTimViec(DoiCoinTimViecActivity.this, getString(R.string.exchange_coin_success));
                    } else {
                        DialogUtils.dialogError(DoiCoinTimViecActivity.this, jsonResult.getString(Common.JsonKey.KEY_MESSAGE));
                    }
