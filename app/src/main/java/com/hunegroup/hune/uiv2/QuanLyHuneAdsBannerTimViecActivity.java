...
public class QuanLyHuneAdsBannerTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quanlyhuneads_banner_timviec);
        findViews();
        initData();
    }
