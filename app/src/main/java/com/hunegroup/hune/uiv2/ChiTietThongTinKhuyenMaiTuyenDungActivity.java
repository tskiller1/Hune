...
public class ChiTietThongTinKhuyenMaiTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_chitiet_thongtinkhuyenmai_tuyendung);
        findViews();
        initData();
    }
