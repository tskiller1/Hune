...
public class ThongTinKhuyenMaiTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_thongtinkhuyenmai_tuyendung);
        findViews();
        initData();
    }
    ...
    private void findViews() {
        ...
        lsvBody.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ThongTinKhuyenMaiTuyenDungActivity.this, ChiTietThongTinKhuyenMaiTuyenDungActivity.class);
