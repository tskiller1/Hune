...
public class HunePayTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_hunepay_timviec);
        findViews();
        initData();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnl_hune_coin:
                startActivityForResult(new Intent(this, HuneCoinTimViecActivity.class), 101);
                break;
            case R.id.lnl_history:
                startActivity(new Intent(this, LichSuGiaoDichCashTimViecActivity.class));
                break;
            case R.id.lnl_withdraw:
                startActivityForResult(new Intent(this, RutTienTimViecActivity.class), 101);
                break;
            case R.id.lnl_recharge:
                startActivityForResult(new Intent(this, NapCashTimViecActivity.class), 102);
