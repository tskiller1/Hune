...
public class ChiTietKhuyenMaiTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
...
//        super.onActivityResult(requestCode, resultCode, data);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_chitietkhuyenmai_tuyendung);
        findViews();
        initData();
    }
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        updateView();
                        dialogMessage = DialogUtils.dialogSuccess(ChiTietKhuyenMaiTuyenDungActivity.this, getString(R.string.use_coupon_success));
                    } else {
                        if (!jsonResult.isNull(Common.JsonKey.KEY_MESSAGE)) {
                            Toast.makeText(ChiTietKhuyenMaiTuyenDungActivity.this, jsonResult.getString(Common.JsonKey.KEY_MESSAGE), Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
