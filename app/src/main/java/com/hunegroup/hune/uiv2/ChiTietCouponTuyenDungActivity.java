...
public class ChiTietCouponTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_chitietcoupon_tuyendung);
        findViews();
        initData();
    }
    ...
    private void updateView() {
        ...
        String numcoupon = couponDTO.getCoupon_count() + " " + "Coupon";
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        dialogMessage = DialogUtils.dialogSuccess(ChiTietCouponTuyenDungActivity.this, getString(R.string.buy_coupon_success), new DialogUtils.DialogCallBack() {
                            @Override
                        ...
                        if (!jsonResult.isNull(Common.JsonKey.KEY_MESSAGE)) {
                            Toast.makeText(ChiTietCouponTuyenDungActivity.this, jsonResult.getString(Common.JsonKey.KEY_MESSAGE), Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
