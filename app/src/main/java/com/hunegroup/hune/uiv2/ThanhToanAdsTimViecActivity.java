...
import com.hunegroup.hune.ui.TimViecActivity;
...
public class ThanhToanAdsTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_thanhtoanads_timviec);
        findViews();
        initData();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_payment:
                dialogQuestion = DialogUtils.dialogQuestionTimViec(this, getString(R.string.confirm_payment), new DialogUtils.DialogCallBack() {
                    @Override
    ...
    private void onBack() {
        dialogQuestionExit = DialogUtils.dialogQuestion(this, getString(R.string.notpayment_wantexit), new DialogUtils.DialogCallBack() {
            ...
            public void onYesClickListener() {
                ...
                Intent intent = new Intent(ThanhToanAdsTimViecActivity.this, HuneAdsTimViecActivity.class);
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        dialogMessage = DialogUtils.dialogSuccessTimViec(ThanhToanAdsTimViecActivity.this, getString(R.string.pay_success), new DialogUtils.DialogCallBack() {
                            @Override
                            public void onYesClickListener() {
                                Intent intent = new Intent(ThanhToanAdsTimViecActivity.this, TimViecActivity.class);
                        ...
                        DialogUtils.dialogErrorTimViec(ThanhToanAdsTimViecActivity.this, getString(R.string.not_enough_payment));
                    }
                ...
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        if (jsonData.getInt("for_ads") == 1) {
                            ...
                            Toast.makeText(ThanhToanAdsTimViecActivity.this, R.string.code_is_not_found, Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(ThanhToanAdsTimViecActivity.this, R.string.code_is_not_found, Toast.LENGTH_SHORT).show();
                    }
