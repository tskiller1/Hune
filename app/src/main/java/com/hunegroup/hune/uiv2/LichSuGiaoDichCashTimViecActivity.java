...
import com.hunegroup.hune.adapterv2.LichSuGiaoDichCashTimViecAdapter;
...
public class LichSuGiaoDichCashTimViecActivity extends AppCompatActivity {
    ...
    LichSuGiaoDichCashTimViecAdapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_lichsugiaodichcash_timviec);
        findViews();
        initData();
    }
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mAdapter = new LichSuGiaoDichCashTimViecAdapter(this, mList);
