...
public class HuneAdsTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_huneads_timviec);
        findViews();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnl_banner_ads:
                startActivity(new Intent(this, QuangCaoBannerTimViecActivity.class));
                break;
            case R.id.lnl_location_ads:
                startActivity(new Intent(this, QuangCaoKhuVucTimViecActivity.class));
                break;
            case R.id.lnl_notification_ads:
                startActivity(new Intent(this, QuangCaoThongBaoTimViecActivity.class));
                break;
            case R.id.lnl_manager_ads:
                startActivity(new Intent(this, QuanLyHuneAdsTimViecActivity.class));
                break;
        }
    }
}
