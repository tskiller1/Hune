...
import com.hunegroup.hune.adapterv2.MuaCouponTimViecAdapter;
...
public class MuaCouponTimViecActivity extends AppCompatActivity implements View.OnClickListener, MuaCouponTimViecAdapter.OnItemClick {
    ...
    MuaCouponTimViecAdapter mAdapter;
    Gson gson = new Gson();
    UserDTO userDTO;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_muacoupon_timviec);
        findViews();
        initData();
    }
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mAdapter = new MuaCouponTimViecAdapter(this, mList, this);
    ...
    public void onItemClickListener(View view, int position, Object item) {
        ...
        Intent intent = new Intent(this, ChiTietCouponTimViecActivity.class);
        intent.putExtra("item", gson.toJson(couponDTO));
