...
public class ChonNgayTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_chonngay_tuyendung);
        findViews();
        initData();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.imv_complete:
                dialogQuestion = DialogUtils.dialogQuestion(this, getString(R.string.select_date_finish), new DialogUtils.DialogCallBack() {
                    @Override
