...
public class QuanLyHuneAdsKhuVucTuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quanlyhuneads_khuvuc_tuyendung);
        findViews();
        initData();
    }
