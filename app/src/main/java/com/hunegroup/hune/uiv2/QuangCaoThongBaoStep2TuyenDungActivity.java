...
public class QuangCaoThongBaoStep2TuyenDungActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quangcaothongbao_step2_tuyendung);
        findViews();
        initView();
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_recruitment:
                if (isRecruiment) {
                    ...
                    isRecruiment = false;
                    tvRecruitment.setBackgroundResource(R.drawable.custom_edittext_danhgia_tuyendung);
                    tvRecruitment.setTextColor(getResources().getColor(R.color.color_main));
                } else {
                    locations.add(1);
                    isRecruiment = true;
                    tvRecruitment.setBackgroundResource(R.drawable.custom_button_danhgia_tuyendung);
            ...
            case R.id.tv_find_job:
                if (isFindJob) {
                    ...
                    isFindJob = false;
                    tvFindJob.setBackgroundResource(R.drawable.custom_edittext_danhgia_tuyendung);
                    tvFindJob.setTextColor(getResources().getColor(R.color.color_main));
                } else {
                    locations.add(2);
                    isFindJob = true;
                    tvFindJob.setBackgroundResource(R.drawable.custom_button_danhgia_tuyendung);
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        Intent intent = new Intent(QuangCaoThongBaoStep2TuyenDungActivity.this, ThanhToanAdsTuyenDungActivity.class);
