...
public class HuneCoinTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_hunecoin_timviec);
        findViews();
        initData();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnl_buy_coin:
                startActivityForResult(new Intent(this, DoiCoinTimViecActivity.class), 101);
                break;
            case R.id.lnl_history:
                startActivity(new Intent(this, LichSuGiaoDichCoinTimViecActivity.class));
                break;
        }
    }
