...
public class QuangCaoKhuVucStep2TimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_quangcaokhuvuc_step2_timviec);
        findViews();
        initData();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_select_num_day:
                startActivityForResult(new Intent(this, ChonNgayTimViecActivity.class), 101);
                break;
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ...
                        Intent intent = new Intent(QuangCaoKhuVucStep2TimViecActivity.this, ThanhToanAdsTimViecActivity.class);
