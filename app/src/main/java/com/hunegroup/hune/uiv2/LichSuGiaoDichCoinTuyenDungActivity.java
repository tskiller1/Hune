...
import com.hunegroup.hune.adapterv2.LichSuGiaoDichCoinTuyenDungAdapter;
...
public class LichSuGiaoDichCoinTuyenDungActivity extends AppCompatActivity {
    ...
    LichSuGiaoDichCoinTuyenDungAdapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_lichsugiaodichcoin_tuyendung);
        findViews();
        initData();
    }
    ...
    private void initData() {
        ...
        mList = new ArrayList<>();
        mAdapter = new LichSuGiaoDichCoinTuyenDungAdapter(this, mList);
