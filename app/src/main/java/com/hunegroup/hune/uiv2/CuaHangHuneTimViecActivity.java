...
public class CuaHangHuneTimViecActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v2_cuahanghune_timviec);
        findViews();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lnl_buy_coupon:
                startActivity(new Intent(this, MuaCouponTimViecActivity.class));
                break;
            case R.id.lnl_my_coupon:
                startActivity(new Intent(this, CouponCuaToiTimViecActivity.class));
                break;
        }
    }
}
