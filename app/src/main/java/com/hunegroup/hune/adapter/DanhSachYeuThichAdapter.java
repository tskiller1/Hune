...
import com.hunegroup.hune.ui.DanhSachYeuThichTuyenDungActivity;
...
public class DanhSachYeuThichAdapter extends ArrayAdapter<FavouriteDTO> {
...
//        vh.imgAvatar.setImageResource();
    ...
    // Constructors
    public DanhSachYeuThichAdapter(Context context, List<FavouriteDTO> objects) {
        super(context, 0, objects);
        sessionUser = new SessionUser(context);
        this.mInflater = LayoutInflater.from( context );
    }
    public DanhSachYeuThichAdapter(Context context, FavouriteDTO[] objects) {
        super(context, 0, objects);
        sessionUser = new SessionUser(context);
        this.mInflater = LayoutInflater.from( context );
    }
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if(code.contains(Common.JsonKey.KEY_SUCCESSFULLY)){
                        DanhSachYeuThichTuyenDungActivity.favouriteDTOList.remove(poi);
