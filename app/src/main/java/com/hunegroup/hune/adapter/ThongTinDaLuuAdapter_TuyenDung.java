...
import com.hunegroup.hune.ui.ThongTinDaLuuTuyenDungActivity;
...
public class ThongTinDaLuuAdapter_TuyenDung extends ArrayAdapter<ThongTinDaLuuDTO> {
    ...
    // Constructors
    public ThongTinDaLuuAdapter_TuyenDung(Context context, List<ThongTinDaLuuDTO> objects) {
        super(context, 0, objects);
        this.context=context;
        sessionUser=new SessionUser(context);
        this.mInflater = LayoutInflater.from( context );
    }
    public ThongTinDaLuuAdapter_TuyenDung(Context context, ThongTinDaLuuDTO[] objects) {
        super(context, 0, objects);
        this.context=context;
        sessionUser=new SessionUser(context);
        this.mInflater = LayoutInflater.from( context );
            ...
            if (result != null) {
                try {
                    ...
                    if (code.contains(Common.JsonKey.KEY_SUCCESSFULLY)) {
                        ThongTinDaLuuTuyenDungActivity.thongTinDaLuuDTOs.remove(poi);
